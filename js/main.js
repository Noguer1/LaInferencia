  ...
  const BOTIQUIN_DATA = {
    productividad: [
      { frente: '¿Por qué sé lo que tengo que hacer y no lo hago?',
        ...
        sinopsis: 'Este libro desmonta el bloqueo desde la raíz y te da herramientas concretas para empezar aunque no te sientas preparado.' },
      { frente: 'Tengo 7 tareas abiertas y no avanzo nada',
        ...
        sinopsis: 'McKeown te entrena para eliminar lo que parece urgente pero no importa, y enfocarte en lo único que mueve la aguja de verdad.' },
      { frente: 'Empiezo con energía y abandono a mitad',
        ...
        sinopsis: 'Lo que separa a quien termina de quien abandona no es el talento sino la perseverancia entrenada. Duckworth explica exactamente cómo se construye esa resistencia.' },
      { frente: 'Siempre digo sí a todo y no llego a nada',
        ...
        sinopsis: 'Este clásico de la asertividad te da un lenguaje concreto para poner límites sin sentir que estás defraudando a nadie.' },
      { frente: 'Trabajo mucho pero siento que no produzco',
        ...
        sinopsis: 'Newport te muestra por qué el trabajo superficial te agota sin avanzar y cómo recuperar la concentración que las notificaciones te han ido robando.' }
    ],
    relaciones: [
      { frente: 'Discuto y la conversación siempre empeora',
        ...
        sinopsis: 'Schopenhauer cataloga las trampas que usamos sin saberlo para ganar en lugar de entendernos, y reconocerlas es el primer paso para salir del bucle.' },
      { frente: 'Me cuesta decir lo que siento sin que suene a ataque',
        ...
        sinopsis: 'Rosenberg ofrece un método simple para expresar necesidades reales sin activar la defensiva del otro.' },
      { frente: 'Asumo lo que el otro piensa y me equivoco',
        ...
        sinopsis: 'Este libro te enseña a distinguir lo que observas de lo que interpretas, y a abrir conversaciones que normalmente se evitan.' },
      { frente: 'Las mismas discusiones se repiten siempre',
        ...
        sinopsis: 'Forward te ayuda a identificar los programas que siguen ejecutándose en automático y a reescribirlos.' },
      { frente: 'Me afectan demasiado los comentarios de otros',
        ...
        sinopsis: 'Ruiz construye una filosofía práctica para dejar de tomar como personal lo que nunca fue dirigido a ti de verdad.' }
    ],
    finanzas: [
      { frente: 'Compro cuando estoy estresado o aburrido',
        ...
        sinopsis: 'Kessel conecta la psicología profunda con el comportamiento financiero y te da herramientas para romper ese circuito antes de que llegues al carrito.' },
      { frente: 'Me cuesta invertir por miedo a perderlo todo',
        ...
        sinopsis: 'Kahneman es la lectura obligatoria para entender por qué tus decisiones financieras casi nunca son tan racionales como crees.' },
      { frente: 'Gasto más con tarjeta que con efectivo',
        ...
        sinopsis: 'Robbins te da una arquitectura mental y práctica para relacionarte con el dinero desde la consciencia y no desde el impulso.' },
      { frente: 'Siento que una oferta es una oportunidad que no puedo perder',
        ...
        sinopsis: 'Cialdini disecciona los 6 mecanismos psicológicos que usa el marketing para que decidas sin darte cuenta de que estás decidiendo.' },
      { frente: 'Sé que debería ahorrar pero lo dejo para después',
        ...
        sinopsis: 'Clason explica de forma irresistiblemente clara por qué pagarte a ti primero es la única regla financiera que realmente cambia el rumbo.' }
    ],
    saludMental: [
      { frente: 'La ansiedad me bloquea antes de poder actuar',
        ...
        sinopsis: 'Brewer explica cómo funciona el bucle de la ansiedad desde la neurociencia y ofrece técnicas basadas en mindfulness para salir de él sin suprimirlo.' },
      { frente: 'No puedo salir de los pensamientos negativos en bucle',
        ...
        sinopsis: 'Williams y Penman ofrecen un programa de 8 semanas basado en la terapia cognitiva para interrumpir el ciclo de rumiación que alimenta la tristeza crónica.' },
      { frente: 'Me afecta todo mucho y no sé cómo regularlo',
        ...
        sinopsis: 'Goleman explica por qué el coeficiente emocional predice el bienestar mejor que el intelectual, y cómo desarrollar las habilidades que nos hacen funcionar con los demás.' },
      { frente: 'Hace tiempo que nada me ilusiona de verdad',
        ...
        sinopsis: 'Desde los campos de concentración, Frankl construye una argumentación poderosa: quien tiene un porqué puede soportar casi cualquier cómo.' },
      { frente: 'Sé que algo me pasa pero no sé ponerle nombre',
        ...
        sinopsis: 'Van der Kolk revolucionó la psicología al demostrar que el trauma vive en el cuerpo. Un libro que redefine lo que significa sanar.' }
    ],
    trabajo: [
      { frente: 'Nada de lo que hago parece suficiente',
        ...
        sinopsis: 'Brown te invita a soltar la armadura del perfeccionismo y construir una vida basada en lo que realmente te importa, no en lo que crees que deberías ser.' },
      { frente: 'Me comparo con compañeros y siempre salgo perdiendo',
        ...
        sinopsis: 'Dweck demuestra que la diferencia entre prosperar y estancarse no es el talento, sino la creencia sobre si ese talento puede cambiar.' },
      { frente: 'Siento que no merezco el puesto que tengo',
        ...
        sinopsis: 'Hibberd explica por qué personas brillantes se sienten un fraude, y ofrece estrategias concretas para cambiar la narrativa interna.' },
      { frente: 'Las reuniones me agotan y siento que pierdo el tiempo',
        ...
        sinopsis: 'Cain reivindica el valor del pensamiento tranquilo en un mundo diseñado para los extrovertidos, con implicaciones directas para cómo organizamos el trabajo.' },
      { frente: 'Me cuesta pedir ayuda por miedo a parecer incapaz',
        ...
        sinopsis: 'Brown convierte la vulnerabilidad en fortaleza, demostrando que la conexión real con los demás solo es posible cuando dejamos de fingir que todo está bajo control.' }
    ],
    autoconocimiento: [
      { frente: 'No sé bien qué quiero de mi vida',
        ...
        sinopsis: 'García y Miralles exploran el concepto japonés de ikigai —la razón de ser— y ofrecen claves concretas para encontrar el cruce entre lo que amas, lo que sabes hacer y lo que el mundo necesita.' },
      { frente: 'Me cuesta mantener las promesas que me hago a mí mismo',
        ...
        sinopsis: 'McGonigal convierte la ciencia del autocontrol en un programa práctico. No se trata de tener más fuerza de voluntad, sino de usarla de forma más inteligente.' },
      { frente: 'Reacciono de formas que luego no entiendo',
        ...
        sinopsis: 'Levine y Heller aplican la teoría del apego adulto para explicar por qué te comportas así en las relaciones cercanas, y cómo cambiar esos patrones.' },
      { frente: 'Siempre pongo las necesidades de los demás antes que las mías',
        ...
        sinopsis: 'Cloud y Townsend explican qué son los límites, por qué nos cuesta tanto tenerlos y cómo establecerlos sin culpa ni conflicto.' },
      { frente: 'Me cuesta cambiar aunque sé que necesito hacerlo',
        ...
        sinopsis: 'Los Heath proponen un marco sencillo con tres elementos: dirigir al jinete racional, motivar al elefante emocional y moldear el camino del entorno.' }
    ],
    crianza: [
      { frente: 'Mi hijo tiene rabietas que no sé cómo manejar',
        ...
        sinopsis: 'Siegel y Bryson explican cómo funciona el cerebro infantil y ofrecen estrategias concretas para convertir los momentos difíciles en oportunidades de desarrollo.' },
      { frente: 'Me preocupa cuánto tiempo pasa mi hijo con el móvil',
        ...
        sinopsis: 'Haidt documenta con datos el impacto de los smartphones en la salud mental de los adolescentes y propone una agenda concreta para los padres y las escuelas.' },
      { frente: 'No sé cómo hablar con mi hijo adolescente',
        ...
        sinopsis: 'Jensen explica la neurociencia detrás del comportamiento adolescente con un lenguaje accesible, transformando la frustración en comprensión.' },
      { frente: 'Siento que estoy transmitiendo mis miedos a mis hijos',
        ...
        sinopsis: 'Siegel y Hartzell muestran cómo la historia emocional de los padres influye en los hijos, y cómo desarrollar la conciencia necesaria para romper esos ciclos.' },
      { frente: 'Pongo límites pero no se cumplen',
        ...
        sinopsis: 'Siegel y Bryson ofrecen un enfoque que combina firmeza y conexión emocional, demostrando que los límites más efectivos son los que no necesitan gritos.' }
    ],
    sueno: [
      { frente: 'No puedo apagar el cerebro cuando me acuesto',
        ...
        sinopsis: 'Walker, neurocientífico de Berkeley, explica con datos por qué el sueño no es un lujo sino el sistema de mantenimiento más crítico de tu cerebro y tu salud.' },
      { frente: 'Me despierto a las 3 de la madrugada y no puedo volver a dormirme',
        ...
        sinopsis: 'El entrenador de sueño de atletas de élite como Cristiano Ronaldo comparte el sistema que usa en el deporte profesional para optimizar la recuperación nocturna.' },
      { frente: 'Duermo 8 horas y sigo amaneciendo destrozado',
        ...
        sinopsis: 'Winter, especialista en medicina del sueño, explica por qué lo que cuentas como descanso quizás no te está reparando y cómo reajustar el sistema sin pastillas.' },
      { frente: 'El estrés del día no me deja desconectar al llegar a casa',
        ...
        sinopsis: 'Estivill, el médico más consultado en España sobre sueño, da un método claro y progresivo para reeducar el ciclo vigilia-sueño sin medicación.' },
      { frente: 'Las pantallas hasta tarde me destrozan las mañanas',
        ...
        sinopsis: 'Alter investiga la ciencia del diseño adictivo desde dentro. Entender cómo funciona es el primer paso para recuperar el control de tus noches.' }
    ],
    ansiedad: [
      { frente: 'Siento que algo malo va a pasar aunque todo vaya bien',
        ...
        sinopsis: 'McDonagh propone una estrategia contraintuitiva basada en ACT: en lugar de combatir la ansiedad, acercarse a ella. Escrito desde su propia recuperación del trastorno de pánico.' },
      { frente: 'Mi cuerpo reacciona antes de que yo entienda qué está pasando',
        ...
        sinopsis: 'Van der Kolk explica con décadas de investigación clínica por qué la ansiedad crónica y el trauma se alojan en el cuerpo, y cuáles son las vías de recuperación que realmente funcionan.' },
      { frente: 'Me preocupo por cosas que sé que probablemente nunca van a pasar',
        ...
        sinopsis: 'Harris introduce la Terapia de Aceptación y Compromiso: no combatir los pensamientos ansiosos sino cambiar la relación que tienes con ellos, reduciendo su impacto sin necesidad de suprimirlos.' },
      { frente: 'Los ataques de pánico me asustan más que el miedo en sí',
        ...
        sinopsis: 'Burns adapta la terapia cognitivo-conductual a un formato accesible y práctico: técnicas concretas para identificar y cortar el ciclo del pánico antes de que escale.' },
      { frente: 'Me siento ansioso sin saber exactamente por qué',
        ...
        sinopsis: 'Maté conecta la biología del estrés con la historia emocional personal, mostrando cómo el cuerpo acaba hablando lo que la mente no ha procesado.' }
    ],
    autoestima: [
      { frente: 'Me critico a mí mismo constantemente por cualquier error',
        ...
        sinopsis: 'Neff, investigadora de referencia mundial en autocompasión, demuestra que tratarse con amabilidad no es debilidad sino la base neurológica de la resiliencia y el rendimiento sostenido.' },
      { frente: 'Necesito que los demás me aprueben para sentirme bien',
        ...
        sinopsis: 'Branden construye el modelo más completo sobre autoestima disponible en español: no como algo que se tiene o no se tiene sino como algo que se practica con acciones diarias específicas.' },
      { frente: 'Siento que no merezco lo bueno que me pasa',
        ...
        sinopsis: 'Hibberd examina la psicología del sentimiento de fraude y ofrece estrategias basadas en TCC para reconocer el patrón y recalibrar la narrativa interna.' },
      { frente: 'Me comparo con los demás y siempre salgo perdiendo',
        ...
        sinopsis: 'Dweck demuestra con 20 años de investigación que la diferencia entre quien crece y quien se estanca no es el talento: es la creencia sobre si ese talento puede cambiar.' },
      { frente: 'Me cuesta aceptar un elogio sin restarlo o negarlo',
        ...
        sinopsis: 'Bucay aborda la relación con uno mismo como el eje del que parten todas las demás, con un lenguaje directo y accesible construido desde décadas de práctica clínica.' }
    ],
    duelo: [
      { frente: 'He perdido a alguien importante y no sé cómo seguir',
        ...
        sinopsis: 'Didion narra con precisión clínica y literaria el año tras la muerte repentina de su marido, convirtiendo la experiencia más íntima en una descripción universal de cómo el duelo transforma la percepción de la realidad.' },
      { frente: 'Una ruptura me tiene completamente paralizado',
        ...
        sinopsis: 'Winch, psicólogo clínico, aplica ciencia al proceso de ruptura y da herramientas específicas para acortar el sufrimiento innecesario sin saltarse el proceso necesario.' },
      { frente: 'Un cambio importante me genera más pérdida que alivio',
        ...
        sinopsis: 'Bridges distingue entre el cambio (lo que ocurre fuera) y la transición (lo que ocurre dentro), y explica por qué gestionar bien los finales es la única forma real de empezar algo nuevo.' },
      { frente: 'Sigo aferrado a algo que ya sé que no va a volver',
        ...
        sinopsis: 'Riso analiza el apego desde la psicología cognitiva y da argumentos y herramientas para soltar sin que sea una rendición: sin anestesia emocional pero sin autocastigo.' },
      { frente: 'Me cuesta aceptar que algo (o alguien) ya no está',
        ...
        sinopsis: 'La psiquiatra que revolucionó la comprensión occidental de la pérdida escribe sobre el duelo desde dentro, combinando la mirada clínica con la experiencia profundamente humana.' }
    ],
    habitos: [
      { frente: 'Sé que debería mantener el hábito pero a la semana lo dejo',
        ...
        sinopsis: 'El libro de hábitos más vendido de la última década. Clear explica que la diferencia no está en la fuerza de voluntad sino en hacer que el comportamiento correcto sea el más fácil.' },
      { frente: 'Intento dejar un mal hábito pero vuelvo a él cuando estoy estresado',
        ...
        sinopsis: 'Duhigg explica la neurociencia del bucle habitual y muestra por qué los hábitos negativos son tan resistentes al cambio voluntario, y cómo hackear el sistema desde dentro.' },
      { frente: 'Empiezo con motivación y a los días ya no puedo más',
        ...
        sinopsis: 'Fogg propone empezar ridículamente pequeño: el tamaño del comportamiento inicial determina si se convierte en hábito automático o se convierte en otra promesa rota.' },
      { frente: 'Cojo el teléfono sin saber cómo llegué a él',
        ...
        sinopsis: 'Eyal explica cómo funciona el diseño adictivo desde dentro —fue el consultor que lo diseñó— y ahora escribe exactamente cómo recuperar el control de la atención.' },
      { frente: 'Cuando estoy solo recaigo en lo de siempre aunque no quiera',
        ...
        sinopsis: 'Baumeister, el mayor investigador en autocontrol del mundo, demuestra que la voluntad no es un rasgo de personalidad sino un recurso que puede gestionarse inteligentemente con estrategias concretas.' }
    ]
  };
