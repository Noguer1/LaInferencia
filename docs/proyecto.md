...
- `/fuera-de-bata/<slug>/` — 10 piezas (3 de Miguel `AUTHOR_OWN_WORKS` + 7 de colaboradoras), también a mano. Mismo navbar estático que la landing (marca + enlaces Fuera de Bata / Rutas / Biblioteca + `#theme-toggle` + "Ir a La Inferencia"), movido por `js/theme-static.js`.
